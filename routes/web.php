...
Route::get('/rebrandly-test', function() {
    ...
    try {
        ...
        $result = $client->post('https://api.rebrandly.com/v1/links', ['body' => json_encode(
                    [
...
Route::get('/view-buffer', 'BufferCntroller@viewBuffer');
Route::get('/search-recentPost', 'BufferCntroller@search_recent_post');